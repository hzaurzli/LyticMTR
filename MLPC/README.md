...
### Supp.
Using Grad_CAM.py to calculate BiGRU layer weight score which is corresponding to secondary structure sequences
...
Using min_length_ss_score.py to calculate different secondary structure average weight score in different length, the main purpose is to check the weight of an entire alpha-helix (or other secondary structure type) 
